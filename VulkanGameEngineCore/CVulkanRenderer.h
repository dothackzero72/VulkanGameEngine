...
VkResult Renderer_StartFrame(VkDevice device, VkSwapchainKHR swapChain, VkCommandBuffer* commandBuffer, VkFence* fenceList, VkSemaphore* acquireImageSemaphoreList, uint32_t* pImageIndex, uint32_t* pCommandIndex, bool* pRebuildRendererFlag);
