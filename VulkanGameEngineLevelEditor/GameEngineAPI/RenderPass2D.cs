...
namespace VulkanGameEngineLevelEditor.GameEngineAPI
{
    public unsafe class RenderPass2D : Renderpass
    {
        ...
        {
            texture = new RenderedTexture(new GlmSharp.ivec2((int)VulkanRenderer.SwapChainResolution.Width, (int)VulkanRenderer.SwapChainResolution.Height), (SampleCountFlags)VkSampleCountFlagBits.VK_SAMPLE_COUNT_1_BIT, (Format)VkFormat.VK_FORMAT_R8G8B8A8_UNORM);
