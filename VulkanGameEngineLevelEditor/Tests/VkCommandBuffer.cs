...
namespace VulkanGameEngineLevelEditor.Tests
{
    unsafe class VkCommandBuffer : IDisposable
    {
        ...
        public void CopyBufferToImage(VkBuffer srcBuffer, Image dstImage, ImageLayout destImageLayout, in BufferImageCopy region)
        {
            vk.CmdCopyBufferToImage(this, srcBuffer, dstImage, destImageLayout, 1, region);
        }

        public void CopyBufferToImage(VkBuffer srcBuffer, Image dstImage, ImageLayout destImageLayout, ReadOnlySpan<BufferImageCopy> regions)
        {
