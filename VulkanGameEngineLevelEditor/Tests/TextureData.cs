...
//        public TextureData(PhysicalDevice physicalDevice,
//                     Device device,
//                     Extent2D extent,
...
//            vk.CreateSampler(device, &samplerinfo, null, out sampler);


//            FormatProperties formatProperties = GetFormatProperties(physicalDevice, format);
...
//        }
//        public FormatProperties GetFormatProperties(PhysicalDevice physicalDevice, Format format)
//        {
...
//        public MemoryRequirements GetMemoryRequirements(Device device, Image image)
//        {
...
//        public void SetImage(Device device, VkCommandBuffer commandBuffer, void* srcData, ulong srcDataSize)
//        {
//            void* data = needsStaging ? stagingBufferData.deviceMemory.MapMemory(0, stagingBufferData.buffer.GetMemoryRequirements().Size)
//                                        : imageData.deviceMemory.MapMemory(0, GetMemoryRequirements(device, imageData.image).Size);
