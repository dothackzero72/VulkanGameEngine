...
namespace VulkanGameEngineLevelEditor.GameEngineAPI
{
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct SilkNullVertex
    {
        public SilkNullVertex()
        {

        }

        public static ListPtr<VertexInputBindingDescription> GetBindingDescriptions()
        {
            return new ListPtr<VertexInputBindingDescription>();
        }

        public static ListPtr<VertexInputAttributeDescription> GetAttributeDescriptions()
        {
