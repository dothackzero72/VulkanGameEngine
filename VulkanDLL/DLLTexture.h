...
extern "C"
{
	...
	DLL_EXPORT VkResult DLL_Texture_CreateTextureImage(VkDevice Device, VkImage* image, VkDeviceMemory memory, int width, int height, uint32 mipmapLevels, VkFormat textureByteFormat);
