...
//
//    RenderPass = RenderPass_BuildRenderPass(cRenderer, renderSystem.renderPassBuildInfoList[RenderPassId]);
//    FrameBufferList = RenderPass_BuildFrameBuffer(cRenderer, RenderPass, renderSystem.renderPassBuildInfoList[RenderPassId], imageViewList, &depthTexture, cRenderer.SwapChainImageViews, renderSystem.RenderPassResolutionList[RenderPassId]);
//    BuildCommandBuffer();
//
