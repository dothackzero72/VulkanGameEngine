...
void Scene::StartUp()
{
	...
	gameObjectList.emplace_back(GameObject::CreateGameObject("adsfda4", List<ComponentTypeEnum> { kRenderMesh2DComponent }));
	gameObjectList.emplace_back(GameObject::CreateGameObject("adsfda5", List<ComponentTypeEnum> { kRenderMesh2DComponent }));
	gameObjectList.emplace_back(GameObject::CreateGameObject("adsfda6", List<ComponentTypeEnum> { kRenderMesh2DComponent }));
	gameObjectList.emplace_back(GameObject::CreateGameObject("adsfda7", List<ComponentTypeEnum> { kRenderMesh2DComponent }));
	gameObjectList.emplace_back(GameObject::CreateGameObject("adsfda8", List<ComponentTypeEnum> { kRenderMesh2DComponent }));
	gameObjectList.emplace_back(GameObject::CreateGameObject("adsfda9", List<ComponentTypeEnum> { kRenderMesh2DComponent }));
	gameObjectList.emplace_back(GameObject::CreateGameObject("adsfda10", List<ComponentTypeEnum> { kRenderMesh2DComponent }));
	gameObjectList.emplace_back(GameObject::CreateGameObject("adsfda11", List<ComponentTypeEnum> { kRenderMesh2DComponent }));
...
void Scene::UpdateRenderPasses()
{
	...
	renderPass2D.UpdateRenderPass(gameObjectList);
