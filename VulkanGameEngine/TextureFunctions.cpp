...
{
	return Texture_QuickTransitionImageLayout(texture.Image, texture.MipMapLevels, &texture.TextureImageLayout, &newLayout);
}
...
{
	return Texture_QuickTransitionImageLayout(texture.Image, texture.MipMapLevels, &oldLayout, &newLayout);
}
...
{
	return Texture_CopyBufferToTexture(texture.Image, buffer, texture.TextureUsage, texture.Width, texture.Height, texture.Depth);
}
...
{
	return Texture_CopyBufferToTexture(image, buffer, textureType, static_cast<int>(textureSize.x), static_cast<int>(textureSize.y), static_cast<int>(textureSize.z));
}
...
{
	return Texture_CopyBufferToTexture(image, buffer, textureType, textureSize.x, textureSize.y, textureSize.z);
}
