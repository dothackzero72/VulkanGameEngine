...
extern "C" {
	...
	DLL_EXPORT VkSurfaceFormatKHR DLL_SwapChain_FindSwapSurfaceFormat(Vector<VkSurfaceFormatKHR>& availableFormats);
	DLL_EXPORT VkPresentModeKHR DLL_SwapChain_FindSwapPresentMode(Vector<VkPresentModeKHR>& availablePresentModes);
	...
	DLL_EXPORT Vector<VkImage> DLL_SwapChain_SetUpSwapChainImages(VkDevice device, VkSwapchainKHR swapChain);
	...
	DLL_EXPORT VkPresentModeKHR* DLL_SwapChain_GetSurfacePresentModes(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface);
	...
	DLL_EXPORT void DLL_SwapChain_DeleteSurfacePresentModes(VkSurfaceFormatKHR* ptr);
	DLL_EXPORT void DLL_SwapChain_DeletePhysicalDeviceFormats(VkSurfaceFormatKHR* ptr);
}
